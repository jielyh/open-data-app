...
// a self contained file that holds all the fucntions we need for users authentication
...
function get_hashed_password ($password) {
	//generates a random to be stores with the password
	// it helps with security and the Blowfish algorthm requires it
